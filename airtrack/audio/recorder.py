...
class MicRecorder:
    ...
    def read(self) -> Optional[np.ndarray]:
        ...
        Returns:
            Float32 array of shape (chunk_size,), or None if no chunk is ready.
        """
        try:
    ...
    def measure_noise_floor(self, duration_sec: float = 1.5) -> float:
        ...
        Args:
            duration_sec: How long to sample the ambient noise.

        Returns:
            RMS amplitude of the noise floor (float32 scale, 0–1).
        """
